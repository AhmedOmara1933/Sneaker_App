...
import 'package:sneaker_shop/modules/home_page.dart';
import 'package:sneaker_shop/modules/my_cart.dart';
import 'package:sneaker_shop/shared/components/default_appbar.dart';
import 'package:sneaker_shop/shared/components/default_size.dart';
    ...
    return Scaffold(
      body: Stack(
        children: [
            ...
            children: [
              Padding(
                ...
                child: DefaultAppBar(
                    ...
                    title: 'Details',
                    actions: 'images/shopping-cart.png',
                  actionsOnTap: (){
               ...
               Image(
                image: AssetImage('${
                    ...
                    mostPopular?.image==null?
                        newArrivals!.image:mostPopular!.image
          ...
          // Positioned(
          //   top: 340.0,left: 0,right: 0,bottom: 0,
          //   child: Container(
          ...
          //               child: Text(
          //                 'Loream ipsum dolor sit amet consectetuer.Duis\n'
          //                 'porttitor purus quam duis molesite non risus\n'
          //                 'purus neque. ipsum lacus id....',
          //                 style:
